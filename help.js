exports.makeHelpText1= function(prefix){
    ...
    helptext=helptext +"**" + prefix + "give *IDName ItemName***: Give an item to the specified character.\n";
    helptext=helptext +"**" + prefix + "pay *IdName Amount***: Pay an amount of cash to another character.\n";
